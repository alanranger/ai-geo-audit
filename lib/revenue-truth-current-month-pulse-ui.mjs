...
function renderPulseVerdict(pulse, tileCls) {
  ...
  return `<div class="rt-pulse-verdict ${tileCls}${d.pulse ? ' is-pulsing' : ''}" style="--defcon-colour:${colour}">`
    ...
    + `<div class="rt-pulse-verdict-legend">${escapeHtml(formatDefconLegend())}</div>`
    + `<div class="rt-pulse-verdict-survival-note">${escapeHtml(SURVIVAL_THRESHOLD_LABEL)}</div>`
