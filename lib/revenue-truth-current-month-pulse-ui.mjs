...
function renderPulseActionsZone(actions) {
  ...
  return `<div class="rt-pulse-actions-zone">`
    + `<h4 class="rt-pulse-actions-head">What to do next`
    + ` <span class="rt-prov-pill rt-prov-editorial" title="Curated high-margin rescue priorities — hand-maintained, not derived from tier deltas.">Editorial Static</span></h4>`
