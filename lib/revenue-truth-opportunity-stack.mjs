/** Curated Revenue Recovery Opportunities — static strategic data + render/bind. */

import { escapeHtml, escapeAttr, fmtMoney } from './revenue-truth-ui-core.mjs';
...
export const OPPORTUNITY_STACK = [
  { id: 1, group: 'A', lever: 'Re-launch £360 4-for-3 Package', tier: '1-2-1 Lessons', tier_anchor: 'one_to_one_lessons', evidence: '£5,040 (2024) → £0 (2026). Pure unlisted-product effect.', low: 1500, mid: 2500, high: 3500, difficulty: 'LOW', confidence: 'HIGH', first_action: 'Republish package on /private-photography-lessons + email past buyers' },
  { id: 2, group: 'A', lever: 'Restore /private-photography-lessons hub', tier: '1-2-1 Lessons', tier_anchor: 'one_to_one_lessons', evidence: '£6,827 (2024) → £936 ann (2026). 9,831 imp/yr remain.', low: 2000, mid: 3500, high: 5000, difficulty: 'LOW', confidence: 'HIGH', first_action: 'Restore primary CTA above fold + republish 4-for-3 package' },
  { id: 3, group: 'A', lever: 'Revive Commercial/Product Shoot product', tier: 'Commissions', tier_anchor: 'commissions', evidence: '£7,262 (2024) → £570 YTD (-92%). Pipeline froze 17 Apr.', low: 1500, mid: 3000, high: 4500, difficulty: 'MED', confidence: 'MED', first_action: 'Outreach to past 2024 commercial clients + agency retainer pitches' },
  { id: 4, group: 'A', lever: 'Fix /professional-commercial-photographer-coventry conversion', tier: 'Commissions', tier_anchor: 'commissions', evidence: '£7,512 (2024) → £3,048 ann. 9,419 imp/yr still there.', low: 1000, mid: 2000, high: 3500, difficulty: 'MED', confidence: 'MED', first_action: 'Diagnose 17 Apr inquiry stop; CRM + GA4 event audit' },
  { id: 5, group: 'B', lever: 'Add 4th cohort of Beginners 3-Weekly Course', tier: 'Courses / Masterclasses', tier_anchor: 'courses_masterclasses', evidence: '£1,045 (2025) → £4,896 ann (2026). Proven product.', low: 1000, mid: 2500, high: 4000, difficulty: 'LOW', confidence: 'HIGH', first_action: 'Schedule autumn cohort + email past Coventry course buyers' },
  { id: 6, group: 'B', lever: 'Fix Academy trial-to-paid funnel (£59/£79)', tier: 'Academy', tier_anchor: 'academy', evidence: '£990 (2025) → £3,127 ann (2026). ~4% trial→paid vs 10-25% SaaS norm.', low: 2000, mid: 4500, high: 8000, difficulty: 'MED', confidence: 'MED', first_action: 'Audit Memberstack day 7/12 nudges; clarify £59 vs £79 at signup' },
  { id: 7, group: 'C', lever: 'Rank /photography-courses-coventry pos 26 → top 10', tier: 'Courses hub', tier_anchor: 'courses_masterclasses', evidence: '70k imp/yr, 604 clicks/yr. Hub routes to product pages.', low: 1500, mid: 3500, high: 6000, difficulty: 'HIGH', confidence: 'MED', first_action: 'Refresh title/H1 for Coventry evening-class intent; lift CTR' },
  { id: 8, group: 'C', lever: 'Fix /hire-a-professional-photographer-in-coventry hub', tier: 'Commissions hub', tier_anchor: 'commissions', evidence: '45k imp/yr, 188 clicks/yr. Routes to commercial/portrait/corporate pages.', low: 1000, mid: 2500, high: 4500, difficulty: 'MED', confidence: 'LOW', first_action: 'Add clear pricing tiers + inquiry form + portfolio above fold' },
  { id: 9, group: 'D', lever: 'Mentoring Monthly Subscription rescue', tier: 'Mentoring', tier_anchor: 'mentoring', evidence: '£1,080 (2024) → £240 ann (2026). Small but recurring.', low: 500, mid: 800, high: 1200, difficulty: 'LOW', confidence: 'MED', first_action: 'Re-promote on /photography-mentoring-online-assignments; reactivate lapsed subs' }
];
...
function dataRow(r, expanded) {
  ...
  return `<tr class="rt-opp-row" data-rt-opp-row="${rowId}" data-tier-anchor="${escapeAttr(r.tier_anchor)}" tabindex="0">`
    ...
    + `<p><strong>Evidence:</strong> ${escapeHtml(r.evidence)}</p>`
