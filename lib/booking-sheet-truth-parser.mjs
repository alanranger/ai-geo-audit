...
//                             category_label, tier_id, revenue_amount,
//                             source_workbook, source_cell_range } ],
...
//                 without a leading number) that requires manual category
//                 review before import. Set lower at your own risk.
export function parseBookingSheetTruth(workbook, options = {}) {
  ...
  return { monthlyPerCategory, verification, warnings };
}
