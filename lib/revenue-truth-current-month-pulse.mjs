...
const DEFCON_META = [
  ...
  { level: 4, label: 'CRITICAL', minPct: 30, maxPct: 45, colour: '#ea580c', pips: 4, pulse: false },
  { level: 3, label: 'SEVERE', minPct: 45, maxPct: 75, colour: '#f59e0b', pips: 3, pulse: false },
  { level: 2, label: 'WARNING', minPct: 75, maxPct: 100, colour: '#a3c04a', pips: 2, pulse: false },
...
export function formatDefconLegend(survivalLine = DEFCON_SURVIVAL_LINE) {
  ...
  const pct = (p) => round2(s * p);
  return `DEFCON 5 <${fmtPlain(pct(0.30))} · 4 ${fmtPlain(pct(0.30))}–${fmtPlain(pct(0.45))} · 3 ${fmtPlain(pct(0.45))}–${fmtPlain(pct(0.75))} · 2 ${fmtPlain(pct(0.75))}–${fmtPlain(s)} · 1 ≥${fmtPlain(s)}`;
}
