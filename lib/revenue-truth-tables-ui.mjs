...
export function renderProductBreakdownTable(findings, options = {}) {
  ...
  const head = `<thead><tr><th>Product</th><th class="rt-cat-col">Revenue category</th><th>12mo</th><th>2026 ann.</th><th>2026 YTD</th><th>2025</th><th>2024</th><th>Δ 25→26</th><th>Δ 24→25</th><th title="Auto flags from canonical_products + revenue shape (hover each chip).">Flags</th><th>2025 #</th></tr></thead>`;
