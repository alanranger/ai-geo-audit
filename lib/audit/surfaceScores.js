...
/** Set on first passing v2 baseline audit (Alan's scheduled run). Rebased 2026-07-16 after hyperlocal pack fix. */
export const SURFACE_VISIBILITY_BASELINE_DATE = '2026-07-16';
