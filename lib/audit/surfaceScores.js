...
/** Set on first passing v2 baseline audit (Alan's scheduled run). */
export const SURFACE_VISIBILITY_BASELINE_DATE = null;
...
export function computeKeywordSurfaceScore(row) {
  ...
  const aioPresent = row?.has_ai_overview === true || row?.ai_overview_present_any === true;
