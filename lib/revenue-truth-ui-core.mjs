...
export const DEFAULT_TIER_BANDS = { survival: 4450, comfortable: 5000, thrive: 8000 };

export const BAND_LABEL = {
  thrive: 'Thrive (£8k+)',
  comfortable: 'Comfortable (£5k–£8k)',
  survival: 'Survival (£4.45k–£5k)',
  below_survival: 'Below survival (<£4.45k)'
};

export const TIER_BAND_TARGETS = { survival: 53400, comfortable: 60000, thrive: 96000 };

export const SURVIVAL_THRESHOLD_LABEL = 'Survival £4,450/mo — full-obligations basis, set 20 Jul 2026';
