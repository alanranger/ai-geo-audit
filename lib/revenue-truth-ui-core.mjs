...
export const DEFAULT_TIER_BANDS = { survival: 3700, comfortable: 5000, thrive: 6000 };

export const BAND_LABEL = {
  thrive: 'Thrive (£6k+)',
  comfortable: 'Comfortable (£5k–£6k)',
  survival: 'Survival (£3.7k–£5k)',
  below_survival: 'Below survival (<£3.7k)'
};

export const TIER_BAND_TARGETS = { survival: 44400, comfortable: 60000, thrive: 72000 };

export const SURVIVAL_THRESHOLD_LABEL = 'Survival £3,700/mo — full-obligations basis, set 16 Sep 2026';
