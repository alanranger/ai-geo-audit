...
export const RECURRING_BASELINE_TIP = 'Recurring baseline = headline minus residential workshops, voucher tiers, and event-bound products (Bluebell, Heather, Lavender, Poppy). The underlying run-rate excluding seasonal / lumpy items.';
