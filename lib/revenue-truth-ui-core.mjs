...
export const DEFAULT_TIER_BANDS = { survival: 5000, comfortable: 6000, thrive: 7000 };

export const BAND_LABEL = {
  thrive: 'Thrive (£7k+)',
  comfortable: 'Comfortable (£6k–£7k)',
  survival: 'Survival (£5k–£6k)',
  below_survival: 'Below survival (<£5k)'
};

export const TIER_BAND_TARGETS = { survival: 60000, comfortable: 72000, thrive: 84000 };

export const SURVIVAL_THRESHOLD_LABEL = 'Survival £5,000/mo — revenue basis, set 16 Sep 2026';
