/**
 * Monday revenue warm only. Tab audits live in Dashboard Full Refresh;
 * CEO email is the last step of that Full run (not a separate audit job).
 */
...
/** Optional delayed Monday report cron. Full Refresh email uses skipGate=true. */
