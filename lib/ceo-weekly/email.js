...
export function renderCeoWeeklyHtml(metrics) {
  ...
  const rollLabel = roll.start && roll.end
    ? `Sales (28d ${roll.start.slice(5)}→${roll.end.slice(5)}) vs £4,450`
    : 'Sales (28d) vs £4,450 survival';
