...
import { TIER_BAND_TARGETS } from './revenue-truth-ui-core.mjs';

export const YEAR_SURVIVAL = TIER_BAND_TARGETS.survival;
export const YEAR_COMFORTABLE = TIER_BAND_TARGETS.comfortable;
