...
### Docs for AI agents / handover
- **`AGENTS.md`** — short index (Supabase project IDs, deploy rules, pointers).
- **`HANDOVER.md`** — full project handover (large; search for “Traditional SEO keyword demand” for KE feature).
- **`Docs/TRADITIONAL_SEO_KEYWORD_METRICS.md`** — Keywords Everywhere cache, API, env vars, troubleshooting.
...
- **`Docs/`** - All markdown documentation files (except README.md, HANDOVER.md, and AGENTS.md which stay in root)
...
- **Root folder** - Only for:
  ...
  - `README.md`, `HANDOVER.md`, and `AGENTS.md` (documentation)
...
- `/api/aigeo/keyword-target-metrics` - Traditional SEO keyword cache: `lookup` (Supabase only) or `refresh` (Keywords Everywhere + upsert). See `Docs/TRADITIONAL_SEO_KEYWORD_METRICS.md`.
