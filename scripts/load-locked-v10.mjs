// Load LOCKED-v10 into repo files + Supabase keywordTrackingLocked + keyword_rankings stubs.
// Usage: node scripts/load-locked-v10.mjs
...
const csvPath = join(root, 'config/keyword-tracking-locations-and-class-LOCKED-v10.csv');
...
await handler(
  { method: 'POST', body: { csv, replaceAll: true, writeFiles: true, version: 'v10' } },
  res
);
