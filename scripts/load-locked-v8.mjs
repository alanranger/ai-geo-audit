// Load LOCKED-v8 into repo files + Supabase keywordTrackingLocked + keyword_rankings stubs.
// Usage: node scripts/load-locked-v8.mjs
...
const csvPath = join(root, 'config/keyword-tracking-locations-and-class-LOCKED-v8.csv');
...
await handler(
  { method: 'POST', body: { csv, replaceAll: true, writeFiles: true, version: 'v8' } },
  res
);
