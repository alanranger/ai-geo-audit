// Load LOCKED-v6 into repo files + Supabase keywordTrackingLocked + keyword_rankings stubs.
// Usage: node scripts/load-locked-v6.mjs
...
const csvPath = join(root, 'config/keyword-tracking-locations-and-class-LOCKED-v6.csv');
...
await handler(
  { method: 'POST', body: { csv, replaceAll: true, writeFiles: true, version: 'v6' } },
  res
);
