// Load LOCKED-v7 into repo files + Supabase keywordTrackingLocked + keyword_rankings stubs.
// Usage: node scripts/load-locked-v7.mjs
...
const csvPath = join(root, 'config/keyword-tracking-locations-and-class-LOCKED-v7.csv');
...
await handler(
  { method: 'POST', body: { csv, replaceAll: true, writeFiles: true, version: 'v7' } },
  res
);
