// Load LOCKED-v5 into repo files + Supabase keywordTrackingLocked + keyword_rankings stubs.
// Usage: node scripts/load-locked-v5.mjs
...
const csvPath = join(root, 'config/keyword-tracking-locations-and-class-LOCKED-v5.csv');
...
await handler(
  { method: 'POST', body: { csv, replaceAll: true, writeFiles: true, version: 'v5' } },
  res
);
