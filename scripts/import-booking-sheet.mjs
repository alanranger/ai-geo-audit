...
function printAggregates(byMonth) {
  ...
  for (const key of [...byMonth.keys()].sort((a, b) => a.localeCompare(b))) {
    ...
    console.log(`  ${key}   | ${f(b.tierRevenue.workshops)} | ${f(b.tierRevenue.courses)} | ${f(b.tierRevenue.services)} | ${f(b.tierRevenue.hire)} | ${f(b.tierRevenue.academy)} | ${f(b.tierRevenue.other)} | ${f(b.revenue)} | ${b.transactions}`);
  }
}
