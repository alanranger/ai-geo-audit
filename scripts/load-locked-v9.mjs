// Load LOCKED-v9 into repo files + Supabase keywordTrackingLocked + keyword_rankings stubs.
// Usage: node scripts/load-locked-v9.mjs
...
const csvPath = join(root, 'config/keyword-tracking-locations-and-class-LOCKED-v9.csv');
...
await handler(
  { method: 'POST', body: { csv, replaceAll: true, writeFiles: true, version: 'v9' } },
  res
);
