...
if (!googleClientId || !googleClientSecret || !googleRefreshToken) {
  ...
  console.error('   These are required to fetch data from Google Search Console API');
  console.error('   They should be set in Vercel environment variables');
  console.error('   Alternatively, call the API endpoint: POST /api/backfill-gsc-data');
  process.exit(1);
}
