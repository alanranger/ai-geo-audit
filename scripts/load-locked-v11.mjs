// Load LOCKED-v11 into repo files + Supabase keywordTrackingLocked + keyword_rankings stubs.
// Usage: node scripts/load-locked-v11.mjs
...
const csvPath = join(root, 'config/keyword-tracking-locations-and-class-LOCKED-v11.csv');
...
await handler(
  { method: 'POST', body: { csv, replaceAll: true, writeFiles: true, version: 'v11' } },
  res
);
