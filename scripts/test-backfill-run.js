/**
 * Test script to run backfill endpoint
 * This simulates the API call by importing and calling the handler directly
 */
...
// Read test data
const testData = JSON.parse(readFileSync('./test-backfill.json', 'utf-8'));
